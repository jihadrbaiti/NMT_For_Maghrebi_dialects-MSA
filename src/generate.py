...
print('Qualitative results of our proposed approach (N2M)')
        ...
        for i, batch in enumerate(test_iter):  
            ...
            for j in range(num_examples):
                try:
                    ...
                    output_words = decode2words1(torch.tensor(generated_indices).squeeze(0).to(device), tokenizer)
...
if __name__ == '__main__':
    ...
    model_path = "./saved/N2M/saved/model.pt"

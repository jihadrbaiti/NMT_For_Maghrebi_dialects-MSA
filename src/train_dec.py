...
print()
print('*************** BERT in Decoder - Maghrebi dialects to MSA - ***************')
print()
...
def run(total_epoch, best_loss):
    ...
    for step in range(total_epoch):
        ...
        if valid_loss < best_loss:
            ...
            torch.save(model.state_dict(), './saved/N2M/saved_dec/model-{0}.pt'.format(valid_loss))

        f = open('./results_final/N2M/result_dec/train_loss.txt', 'w+')
        f.write(str(train_losses))
        f.close()

        f = open('./results_final/N2M/result_dec/bleu.txt', 'w+')
        f.write(str(bleus))
        f.close()

        f = open('./results_final/N2M/result_dec/bleu2.txt', 'w+')
        f.write(str(bleus2))
        f.close()

        f = open('./results_final/N2M/result_dec/ter.txt', 'w+')
        f.write(str(ters))
        f.close()

        f = open('./results_final/N2M/result_dec/chrf.txt', 'w+')
        f.write(str(chrfs))
        f.close()

        f = open('./results_final/N2M/result_dec/test_loss.txt', 'w+')

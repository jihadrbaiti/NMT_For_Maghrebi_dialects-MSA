...
print()
print('*************** Result of Config1/unprepro/Final_inverse ***************')
print()
...
def run(total_epoch, best_loss):
    ...
    for step in range(total_epoch):
        ...
        f = open('./Result_config1/M2N/unprepro/result_f/train_loss.txt', 'w+')
        f.write(str(train_losses))
        f.close()

        f = open('./Result_config1/M2N/unprepro/result_f/bleu.txt', 'w+')
        f.write(str(bleus))
        f.close()

        f = open('./Result_config1/M2N/unprepro/result_f/bleu2.txt', 'w+')
        f.write(str(bleus2))
        f.close()

        f = open('./Result_config1/M2N/unprepro/result_f/ter.txt', 'w+')
        f.write(str(ters))
        f.close()

        f = open('./Result_config1/M2N/unprepro/result_f/chrf.txt', 'w+')
        f.write(str(chrfs))
        f.close()

        f = open('./Result_config1/M2N/unprepro/result_f/test_loss.txt', 'w+')

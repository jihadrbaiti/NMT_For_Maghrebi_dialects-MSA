...
class DataLoader1:
    ...
    def convert_int2tensor(self, train_df1, train_df2, valid_df1, valid_df2, test_df1, test_df2):
        ...
        return train_seq_msa, train_mask_msa, train_seq_nad, train_mask_nad, val_seq_msa, val_mask_msa, val_seq_nad, val_mask_nad, test_seq_msa, test_mask_msa, test_seq_nad, test_mask_nad

    def create_data_loader(self, seq_tensor1, mask_tensor1, seq_tensor2, mask_tensor2, batch_size):
        data = TensorDataset(seq_tensor1, mask_tensor1, seq_tensor2, mask_tensor2)

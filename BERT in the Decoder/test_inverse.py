...
print()
print('***************Result of test set of Config1/unprepro/bert in the decoder M2N***************')
print()
...
def test_model(num_examples):
    iterator = test_iter
    model.load_state_dict(torch.load("saved/model-0.243255335334185.pt",map_location=torch.device('cpu')))

...
print()
print('***************Result of Config1/unprepro/dec***************')
print()
...
def run(total_epoch, best_loss):
    ...
    for step in range(total_epoch):
        ...
        f = open('./Result_config1/N2M/unprepro/result_dec/train_loss.txt', 'w+')
        f.write(str(train_losses))
        f.close()

        f = open('./Result_config1/N2M/unprepro/result_dec/bleu.txt', 'w+')
        f.write(str(bleus))
        f.close()

        f = open('./Result_config1/N2M/unprepro/result_dec/bleu2.txt', 'w+')
        f.write(str(bleus2))
        f.close()

        f = open('./Result_config1/N2M/unprepro/result_dec/ter.txt', 'w+')
        f.write(str(ters))
        f.close()

        f = open('./Result_config1/N2M/unprepro/result_dec/chrf.txt', 'w+')
        f.write(str(chrfs))
        f.close()

        f = open('./Result_config1/N2M/unprepro/result_dec/test_loss.txt', 'w+')

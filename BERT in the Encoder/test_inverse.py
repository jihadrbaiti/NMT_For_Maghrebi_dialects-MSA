...
print()
print('***************Result of test set of Config1/unprepro/bert in the encoder M2N***************')
print()
...
def test_model(num_examples):
    iterator = test_iter
    model.load_state_dict(torch.load("/saved/model-1.483794863159592.pt", map_location=torch.device('cpu')))

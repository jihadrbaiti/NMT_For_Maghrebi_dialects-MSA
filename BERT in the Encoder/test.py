...
print()
print('***************Result of test of Config1/unprepro/bert in the encoder***************')
print()
...
def test_model(num_examples):
    iterator = test_iter
    model.load_state_dict(torch.load("/saved/model-1.337022919912596.pt", map_location=torch.device('cpu')))
